...
public class creativebakeryinc {
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        // Example: Add your block or items to the Creative Mode tab INGREDIENTS (or choose another tab)
        // Replace with your own items/blocks
        // event.accept(ModItems.EXAMPLE_ITEM);
        // event.accept(ModBlocks.DUSTY_HAMMER.get());
    }
